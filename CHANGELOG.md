...
## [4.1.4] - 2026-09-12
### Added
- Add EditorBrowsableState.Never to Obsoleted classes
### Changed
- Update libraries
...
## [4.1.2] - 2026-07-20
### Added
- Embed the source code as a build artifact

## [4.0.5] - 2026-06-18
### Changed
- Add `[EditorBrowsable(EditorBrowsableState.Never)]` to  `Slice()`.

## [4.0.4] - 2026-05-05
### Removed
- Replace `IModInt<T>.Create` with `IModInt<T>.Raw`.
